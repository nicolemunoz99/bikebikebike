    ...
    <PageWrapper title="Welcome">
        ...
        <Row className="mt-4">
          <Col>
            <h2>Demo</h2>
            <p>
              <CustomNavLink tag='span' to='/login' className='text-link'>Sign in</CustomNavLink> using:
            </p>
            <ul>
              <li>u/n: demo</li>
              <li>p/w: demo123</li>
            ...
            <h2>Features</h2>
            <p>
              While Strava allows you to add a narrow selection of parts to your bikes, {process.env.APP_NAME} is different in that you can:
            </p>
            <ul>
                <li>
